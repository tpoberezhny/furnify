...
const BenefitCard: React.FC<BenefitCardProps> = ({
  ...
  return (
    <div
      className="relative aspect-square md:aspect-auto bg-cover bg-center rounded-md overflow-hidden w-[323px] h-[358px] md:h-[498px] bg-gray-500"
      style={{ backgroundImage: `url(${imageUrl})` }}
    >
      <div className={`absolute ${positionClasses} p-4`}>
        {blurTextBg ? (
          <div className="bg-white bg-opacity-70 background-blur-sm p-2 rounded">
